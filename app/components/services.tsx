    ...
    return <>
        <section className="px-14">
            <div className="container mx-auto">
              ...
              duration: 1
            }} className="bg-white shadow-lg text-center p-5 lg:p-10 rounded-2xl bg-[url('https://plus.unsplash.com/premium_photo-1661302908772-e19a215c118a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mjl8fGh1bWFuJTIwcmVzb3VyY2VzfGVufDB8fDB8fHww')] lg:h-[300px]">
              ...
              duration: 1
                    ...
                    <div className="w-full lg:w-1/3 p-5">
                        <motion.div whileHover={{ scale: 1.1 }} transition={{
              duration: 1
            }} className="bg-white shadow-lg text-center p-5 lg:p-10 rounded-2xl bg-[url('https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NTV8fGh1bWFuJTIwcmVzb3VyY2VzfGVufDB8fDB8fHww')] h-[300px]">
                            <div className="py-3 mt-32 lg:py-6 ">
                    ...
                    <div className="w-full lg:w-1/3 p-5">
                        <motion.div whileHover={{ scale: 1.1 }} transition={{
              duration: 1
            }} className="bg-white shadow-lg text-center p-5 lg:p-10 rounded-2xl bg-[url('https://plus.unsplash.com/premium_photo-1661286630002-6c45078cb151?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fFJlc3VtZSUyMHdyaXRpbmd8ZW58MHx8MHx8fDA%3D')] h-[300px]">
                    ...
                    <div className="w-full lg:w-1/3 p-5">
                        <motion.div whileHover={{ scale: 1.1 }} transition={{
              duration: 1
            }} className="bg-white shadow-lg text-center p-5 lg:p-10 rounded-2xl bg-[url('https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8YnVzaW5lc3MlMjBwcm9jZXNzJTIwb3V0c291cmNpbmd8ZW58MHx8MHx8fDA%3D')] h-[300px]">
                            <div className="mt-32 py-3 lg:py-6">
