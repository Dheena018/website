            ...
            <footer className="bg-black dark:bg-gray-900">
                <div className="mx-auto w-full max-w-screen-xl">
                    <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-5">
                        <div className="mb-6 md:mb-0 hidden lg:block">
                            <a href="https://flowbite.com/" className="flex items-center">
                                <img src="/assets/remove-bg.png" className="h-10 me-3 bg-white" alt="FlowBite Logo" />
                            </a>
                        </div>
                        <div>
                    ...
                    <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2024 <a href="https://flowbite.com/">Leventis™</a>. All Rights Reserved.
                        </span>
                        <div className="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse items-center">
                            ...
                            <a href="#" className="text-gray-400 hover:text-white hover:bg-blue-700 rounded-full dark:hover:text-white">
                                <svg className="hover:p-1 w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 21 16">
                            ...
                            <a href="#" className="text-gray-400 hover:text-sky-500 dark:hover:text-white">
                            ...
                            <a href="#" className="text-gray-400 hover:text-pink-500 dark:hover:text-white">
                                <svg className="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
